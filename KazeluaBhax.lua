...
elseif str:find("buttonClicked|dialog_default") then
  setDialog(35, 120, 180, 200,   15, 70, 120, 255, "`wDefault")
  return true
...
AddHook("OnSendPacketRaw", "HookRaw", function(a)
    if dbox_tp == true then
...
SendVariantList({
  [0] = "OnDialogRequest", [1] = wm
    ...
    say("`2(shamrock) [Kazelua Proxy By TegarP [1].4] (shamrock)")
    Sleep(1500)
